...
export default async function DogProfilePage({ params, searchParams }: { params: Record<string, string | string[]>, searchParams?: Record<string, string | string[] | undefined> }) {
